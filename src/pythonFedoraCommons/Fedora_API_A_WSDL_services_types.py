"""
################################################## 
# Fedora_API_A_WSDL_services_types.py 
...
class ns0:
    ...
    class getDatastreamDissemination_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TC.String(pname="pid", aname="_pid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dsID", aname="_dsID", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="asOfDateTime", aname="_asOfDateTime", minOccurs=1, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
    ...
    class getDissemination_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TC.String(pname="pid", aname="_pid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="bDefPid", aname="_bDefPid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="methodName", aname="_methodName", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), self.__class__.parameters_Dec(minOccurs=1, maxOccurs=1, nillable=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="asOfDateTime", aname="_asOfDateTime", minOccurs=1, maxOccurs=1, nillable=True, typed=False, encoded=kw.get("encoded"))]
    ...
    class modifyDatastreamByValue_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TC.String(pname="pid", aname="_pid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dsID", aname="_dsID", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), GTD("http://www.fedora.info/definitions/1/0/types/","ArrayOfString",lazy=False)(pname="altIDs", aname="_altIDs", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dsLabel", aname="_dsLabel", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="MIMEType", aname="_MIMEType", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="formatURI", aname="_formatURI", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Base64String(pname="dsContent", aname="_dsContent", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="checksumType", aname="_checksumType", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="checksum", aname="_checksum", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="logMessage", aname="_logMessage", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="force", aname="_force", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
    ...
    class getDatastream_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TC.String(pname="pid", aname="_pid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dsID", aname="_dsID", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="asOfDateTime", aname="_asOfDateTime", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
    ...
    class getDatastreams_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TC.String(pname="pid", aname="_pid", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="asOfDateTime", aname="_asOfDateTime", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dsState", aname="_dsState", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
